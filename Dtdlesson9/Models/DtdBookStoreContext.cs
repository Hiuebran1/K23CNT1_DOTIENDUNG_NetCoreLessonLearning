...
public partial class DtdBookStoreContext : DbContext
{
    public DtdBookStoreContext()
    {
    }

    public DtdBookStoreContext(DbContextOptions<DtdBookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-U119J93F\\SQLEXPRESS;Database=DtdBookStore;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A614DADF10");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2077EE531A4");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B79246103");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF0A5A4779");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36CBA1E5E83");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABD5449B6C");
